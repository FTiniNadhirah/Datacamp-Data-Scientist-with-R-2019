...
# Instructions
# 100 XP
# Using Markdown syntax, insert the plot you produced in the second chapter in the appropriate section at the end of the report (on line 142).
# Use http://s3.amazonaws.com/assets.datacamp.com/production/course_5807/datasets/relationship.png as URL.
# If you can't remember the syntax, best re-watch the video.
# Use "The relationship between weekly working hours and hourly compensation." as image caption.
