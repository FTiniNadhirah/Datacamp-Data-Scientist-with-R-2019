...
# Instructions
# 100 XP
# Add options to the last R code chunk (on line 83), specifying an image height and width of 8 and 4.5 inches, respectively.
# Also add an option so that the image is always displayed in the center of the RMarkdown report.
# Use the fig.* option family for these settings - to know which exactly, best re-watch the video.
