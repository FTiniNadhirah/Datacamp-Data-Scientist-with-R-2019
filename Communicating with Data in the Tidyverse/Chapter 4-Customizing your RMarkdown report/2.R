...
# Instructions
# 100 XP
# Change the YAML header so your report now contains a non-floating TOC.
# Use the toc and toc_float YAML keys for this.
# Using toc_depth, make your TOC also display the level 4 section header at the end of the report. By default, TOCs go only two levels of sections deep.
